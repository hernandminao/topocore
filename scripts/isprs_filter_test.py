"""
Corre CSF (TopoCore) sobre un sitio real del benchmark ISPRS Filter
...
Definiciones (segun el reporte oficial del benchmark, ITC/TU Delft):
    Type I error  = % de puntos de TERRENO real que CSF clasifico
                    mal como objeto (omision -- terreno perdido)
    Type II error = % de puntos de OBJETO real que CSF clasifico
...
if __name__ == "__main__":
    ...
    parser.add_argument("nube", help="Ruta al archivo de la nube (ej. FSite8_orig.txt)")
    ...
    parser.add_argument("--rigidness", type=int, default=3, choices=(1, 2, 3), help="1=blanda, 3=rigida")
