...
def correr_isprs(
    ...
    print(f"\n=== {ruta_n.name} vs {ruta_r.name} (GRID) ===")
    ...
    clasificador = GridGroundClassifier(
        cell_size=cell_size,
    ...
    print(f"\n=== Resultado GRID (cell_size={cell_size}, height_threshold={height_threshold}) ===")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--height-threshold", type=float, default=0.2)
    args = parser.parse_args()

    correr_isprs(args.nube, args.referencia, args.cell_size, args.height_threshold)
