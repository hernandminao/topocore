...
from topocore.io.ply.enums import PLYFormat, PLYScalarType, PLY_NUMPY_DTYPES
...
class TestPLYConverter:
    ...
    def test_populate_color(self) -> None:
        ...
        np.testing.assert_array_equal(chunk[PointAttribute.COLOR], np.array([[10, 30, 50], [20, 40, 60]], dtype=np.uint8))
