...
# ----------------------------------------------------------------------
# Geoid fixtures -- added for Workflow.transform_vertical()'s own
# test suite. Same synthetic-GeoTIFF-via-GDAL approach already
# established in topocore.geodesy.vertical's own conftest.py (see
# that file for the full rationale/compatibility notes on why
# struct-based raster IO is used instead of GDAL's own gdal_array
# bridge); duplicated here rather than shared via a higher-level
# conftest.py to avoid changing that existing file's own location or
# import structure.
# ----------------------------------------------------------------------
